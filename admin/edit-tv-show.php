                                ...
                                <div>
                                    ...
                                    <select name="intro_ad_id" class="w-full bg-gray-700 border border-gray-600 rounded px-3 py-2 text-white text-sm">
                                        ...
                                        <?php foreach ($all_ads as $ad): ?>
                                            ...
                                            <option value="<?php echo $ad['id']; ?>" <?php echo ($show['intro_ad_id'] ?? null) == $ad['id'] ? 'selected' : ''; ?>>
                                ...
                                <div>
                                    ...
                                    <select name="pre_roll_ad_id" class="w-full bg-gray-700 border border-gray-600 rounded px-3 py-2 text-white text-sm">
                                        ...
                                        <?php foreach ($all_ads as $ad): ?>
                                            ...
                                            <option value="<?php echo $ad['id']; ?>" <?php echo ($show['pre_roll_ad_id'] ?? null) == $ad['id'] ? 'selected' : ''; ?>>
                                ...
                                <div>
                                    ...
                                    <select name="mid_roll_ad_id" class="w-full bg-gray-700 border border-gray-600 rounded px-3 py-2 text-white text-sm">
                                        ...
                                        <?php foreach ($all_ads as $ad): ?>
                                            ...
                                            <option value="<?php echo $ad['id']; ?>" <?php echo ($show['mid_roll_ad_id'] ?? null) == $ad['id'] ? 'selected' : ''; ?>>
                                                <?php echo htmlspecialchars($ad['name']); ?>
                                            </option>
                                            <?php endif; ?>
                                        <?php endforeach; ?>
                                ...
                                <div>
                                    ...
                                    <select name="end_roll_ad_id" class="w-full bg-gray-700 border border-gray-600 rounded px-3 py-2 text-white text-sm">
                                        ...
                                        <?php foreach ($all_ads as $ad): ?>
                                            ...
                                            <option value="<?php echo $ad['id']; ?>" <?php echo ($show['end_roll_ad_id'] ?? null) == $ad['id'] ? 'selected' : ''; ?>>
                                                <?php echo htmlspecialchars($ad['name']); ?>
                                            </option>
                                            <?php endif; ?>
                                        <?php endforeach; ?>
                                ...
                                <div>
                                    ...
                                    <select name="loop_ad_id" class="w-full bg-gray-700 border border-gray-600 rounded px-3 py-2 text-white text-sm">
                                        ...
                                        <?php foreach ($all_ads as $ad): ?>
                                            ...
                                            <option value="<?php echo $ad['id']; ?>" <?php echo ($show['loop_ad_id'] ?? null) == $ad['id'] ? 'selected' : ''; ?>>
                                ...
                                <div>
                                    ...
                                    <select name="banner_ad_id" class="w-full bg-gray-700 border border-gray-600 rounded px-3 py-2 text-white text-sm">
                                        ...
                                        <?php foreach ($all_ads as $ad): ?>
                                            ...
                                            <option value="<?php echo $ad['id']; ?>" <?php echo ($show['banner_ad_id'] ?? null) == $ad['id'] ? 'selected' : ''; ?>>
                                                <?php echo htmlspecialchars($ad['name']); ?>
                                            </option>
                                            <?php endif; ?>
                                        <?php endforeach; ?>
                                ...
                                <div>
                                    ...
                                    <select name="popup_ad_id" class="w-full bg-gray-700 border border-gray-600 rounded px-3 py-2 text-white text-sm">
                                        ...
                                        <?php foreach ($all_ads as $ad): ?>
                                            ...
                                            <option value="<?php echo $ad['id']; ?>" <?php echo ($show['popup_ad_id'] ?? null) == $ad['id'] ? 'selected' : ''; ?>>
                                                <?php echo htmlspecialchars($ad['name']); ?>
                                            </option>
                                            <?php endif; ?>
                                        <?php endforeach; ?>
