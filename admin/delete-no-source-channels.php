...
<div class="bg-gray-900 rounded-lg p-6 mb-8">
    ...
    <div class="bg-gray-800 rounded-lg p-6 mb-6">
        ...
        <form method="POST" id="deleteForm" onsubmit="return confirm('Are you absolutely sure you want to delete <?php echo count($channels_to_delete); ?> channel(s) with no sources? This action cannot be undone!');">
